  ...
  return (
    <div className="relative w-full">
      <Input
        ...
        className="w-full bg-[#222222] text-white border border-gray-700 rounded-xl px-6 py-6 placeholder-gray-400 text-lg font-medium shadow-lg"
      />
      
      {showPromptMenu && (
        <div className="absolute bottom-full mb-0.5 w-full bg-[#222222] rounded-xl shadow-lg border border-gray-700">
          <div className="p-2">
            ...
            {filteredPrompts.length > 0 ? (
              filteredPrompts.map((prompt) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 text-white hover:bg-[#2A2B32] transition-all duration-200 rounded-lg"
                >
