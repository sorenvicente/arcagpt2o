...
const UserMessage = ({ content }: UserMessageProps) => {
  ...
  return (
    ...
    >
      <div className="bg-gray-700/50 rounded-[20px] px-4 py-2 inline-block before:content-[''] before:absolute before:inset-0 before:-left-[113.4px] before:-right-[113.4px] before:-top-[113.4px] before:-bottom-[113.4px] before:z-[-1]">
        {isHovered && !isEditing && (
          <TooltipProvider>
            <Tooltip>
