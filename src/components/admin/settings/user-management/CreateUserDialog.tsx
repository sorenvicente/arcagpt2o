  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogTrigger asChild>
        <Button className="flex items-center gap-2 bg-[#40414F] hover:bg-[#2A2B32] text-[#9b87f5] hover:text-white border border-[#4E4F60] shadow-md hover:shadow-lg transition-all duration-200 rounded-xl">
