...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:right-0 sm:top-auto sm:bottom-0 sm:flex-col md:max-w-[380px]",
      className
    )}
    {...props}
  />
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(toastVariants({ variant }), 
        "sm:max-w-[320px] data-[state=open]:sm:slide-in-from-bottom-full",
        className
      )}
      {...props}
    />
