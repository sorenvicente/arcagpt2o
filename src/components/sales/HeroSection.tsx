  ...
  return (
    <div className="text-center mb-24 animate-fade-in">
      <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600/20 to-blue-600/20 px-4 py-2 rounded-full mb-8">
        ...
        <span className="text-sm text-purple-400">Potencialize seu Negócio com IA</span>
      </div>
      ...
      <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
        Desenvolva seu propósito, método único, mentorias e cursos com a ajuda da nossa IA.
        <br />
        Gere conteúdo envolvente e ofertas irresistíveis de forma automática.
      </p>
      <Button
